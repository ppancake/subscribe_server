...
int main()
{
    cout<<"服务器1端口号和地址： "<<SRV1_PORT<<"-"<<SRV1_ADDR<< endl;
    int listenfd;//监听套接字
    ...
    if(bind(listenfd,(sockaddr *)&srvaddr1,sizeof(srvaddr1 ))<0)
        ERR_EXIT("bind");
